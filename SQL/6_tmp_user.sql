...
values (null,nvl(to_timestamp(nullif('${PREV_TS['tmp_user']}',''),'yyyy-mm-dd hh24:mi:ss.us'),'2000-01-01'),to_timestamp('${LAST_TS['User']}','yyyy-mm-dd hh24:mi:ss.us'),now(),'tmp_finish',null,'tmp_user');
...
where t._sys_updated_at > nvl(to_timestamp(nullif('${PREV_TS['tmp_user']}',''),'yyyy-mm-dd hh24:mi:ss.us'),'2000-01-01') and t._sys_updated_at <= to_timestamp('${LAST_TS['User']}','yyyy-mm-dd hh24:mi:ss.us')
) ij;
