...
select   ab.AccountId, 
    ...
    join stg_csv_AccountBudgetDetail_merge abd on Ab.ACCOUNTBUDGETId = abd.ACCOUNTBUDGETId and ab.tenantid=abd.tenantid
    join stg_csv_BUDGETSCENARIO_merge BS on ab.BUDGETSCENARIOID = BS.BUDGETSCENARIOID and ab.tenantid = bs.tenantid
